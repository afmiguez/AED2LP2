...
public class KruskalMST {
    ...
    public static void testMyMSTSolution(String args[]){
	In in = new In(args[0]);
	EdgeWeightedGraph G = new EdgeWeightedGraph(in);
	KruskalMST mst = new KruskalMST(G);
	
	In in2 = new In(args[1]);
	EdgeWeightedGraph T = new EdgeWeightedGraph(in2);
	if(mst.check(T)){
	    System.out.println("Solução correta");
	}
	else{
	    System.out.println("Solução incorreta");
	}
